# Dokumentstruktur — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Konsolidera 6 docs-filer till CONTEXT.md + TODO.md för att minska AI:s filläsningskostnad vid sessionsstart.

**Architecture:** CLAUDE.md = invarianter, docs/CONTEXT.md = nuläge (absorberar 6 gamla filer), TODO.md = sessionlogg. De 6 gamla filerna raderas efter absorption.
...
| Fil | Åtgärd | Ansvar |
|-----|--------|--------|
| `CLAUDE.md` | Modifiera | Uppdatera dokumentationspekare, lägg till läsanvisning |
| `docs/CONTEXT.md` | Skapa | Absorberar ARCHITECTURE + FEATURES + FLOWS + DESIGN + ROADMAP + BUSINESS |
| `TODO.md` | Skapa | Sessionlogg med nuläge + prioriterad backlog |
| `docs/ARCHITECTURE.md` | Radera | Absorberad av CONTEXT.md |
| `docs/FEATURES.md` | Radera | Absorberad av CONTEXT.md |
| `docs/FLOWS.md` | Radera | Absorberad av CONTEXT.md |
| `docs/DESIGN.md` | Radera | Absorberad av CONTEXT.md |
| `docs/ROADMAP.md` | Radera | Absorberad av CONTEXT.md |
| `docs/BUSINESS.md` | Radera | Absorberad av CONTEXT.md |

---

### Task 1: Skapa docs/CONTEXT.md

**Files:**
- Create: `docs/CONTEXT.md`

- [ ] **Steg 1: Skapa docs/CONTEXT.md med följande innehåll**
...
- [ ] **Steg 2: Verifiera att alla 10 sektioner finns**

```bash
grep "^## " docs/CONTEXT.md
```

Förväntat output (10 rader):
```
## Projektstruktur
## Databastabeller (RLS aktiverat på alla)
## AI-integration
...
git commit -m "docs: skapa CONTEXT.md — absorberar 6 gamla docs-filer"
```

---

### Task 2: Uppdatera CLAUDE.md

**Files:**
- Modify: `CLAUDE.md`

- [ ] **Steg 1: Ersätt Dokumentation-sektionen i CLAUDE.md**

Byt ut denna sektion:
```markdown
## Dokumentation
...
- [ ] **Steg 2: Verifiera att gamla filpekare är borta**

```bash
grep "ARCHITECTURE\|DESIGN\|FEATURES\|FLOWS\|ROADMAP\|BUSINESS" CLAUDE.md
```

Förväntat output: tomt (inga träffar).

- [ ] **Steg 3: Commit**

```bash
git add CLAUDE.md
git commit -m "docs: uppdatera CLAUDE.md med nya dokumentationspekare"
```

---

### Task 3: Skapa TODO.md

**Files:**
- Create: `TODO.md`

- [ ] **Steg 1: Skapa TODO.md med aktuellt projektläge**
...
```bash
git add TODO.md
git commit -m "docs: skapa TODO.md — sessionlogg för AI-stödd utveckling"
```

---

### Task 4: Radera gamla docs-filer

**Files:**
- Delete: `docs/ARCHITECTURE.md`, `docs/FEATURES.md`, `docs/FLOWS.md`, `docs/DESIGN.md`, `docs/ROADMAP.md`, `docs/BUSINESS.md`

- [ ] **Steg 1: Radera de 6 gamla filerna**

```bash
git rm docs/ARCHITECTURE.md docs/FEATURES.md docs/FLOWS.md docs/DESIGN.md docs/ROADMAP.md docs/BUSINESS.md
```

- [ ] **Steg 2: Verifiera att bara CONTEXT.md finns kvar i docs/ (förutom superpowers/)**
...
```bash
git commit -m "docs: radera gamla docs-filer (absorberade av CONTEXT.md)"
```
